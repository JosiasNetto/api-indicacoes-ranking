...
export async function getRanking() {
    ...
    const rankingWithScore = subscribers.map((subs) => { return { id: subs.id, name: subs.name, score: subscriberIdAndScore[subs.id] }}
).sort((sub1, sub2) => { return sub2.score - sub1.score })
